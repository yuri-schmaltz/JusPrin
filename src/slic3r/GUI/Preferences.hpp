...
public:
    ...
    wxBoxSizer *create_item_text_input(wxString title, wxString title2, wxWindow *parent, wxString tooltip, std::string section, std::string param, std::function<void(wxString)> onchange = {});
