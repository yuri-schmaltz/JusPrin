...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("JusPrin is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("JusPrin is based on Orca Slicer"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // version
    {
        ...
        auto version_string = _L("JusPrin") + " " + std::string(SoftFever_VERSION);
    ...
    text_list.push_back(_L("JusPrin is based on Orca Slicer."));
    ...
    wxStaticText *html_text = new wxStaticText(this, wxID_ANY, "Copyright(C) 2022-2025 Obico All Rights Reserved", wxDefaultPosition, wxDefaultSize);
